...
Last audit snapshot: 2026-06-29, updated after the final private-incubation hard-delete pass.
...
The final hard-delete pass removed the remaining legacy contract residue:
...
The preceding preview-identity hard cut removed the real runtime preview defaults for:
