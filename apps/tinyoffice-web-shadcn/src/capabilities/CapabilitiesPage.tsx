...
function Info({ title, children }: { title: string; children: ReactElement }): ReactElement { return <section className="grid gap-2 border-t pt-4 text-sm"><h3 className="font-semibold">{title}</h3>{children}</section>; }
