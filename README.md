...
> TinyOffice is under active development and is not ready for production use. Authentication, deployment hardening, and the public release process are still being completed.
...
The clean-public-repository transition is tracked in [Open-source distribution](docs/product/open-source-distribution.md). Until that transition is complete, the existing GitHub repository remains a private incubation archive.
