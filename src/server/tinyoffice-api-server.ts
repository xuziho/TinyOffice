...
const TINYOFFICE_API_PREFIX = /^\/api\/(?:auth(?:\/|$)|tinyoffice\/(?:auth\/status|profile|backups(?:\/|$)|updates(?:\/|$)|session\/current)|runtime\/models|companies(?:$|\/[^/]+(?:$|\/(?:access|branding|capabilities|chat|directory|doctor|employees|intake|mcp|member-directory|member-runtime|prompt-policy|sessions|skills|system-ai|tasks|work)(?:\/|$))))/;
